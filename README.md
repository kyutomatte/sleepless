...
1. [Download Sleepless_0.1.1_aarch64.dmg](https://github.com/kyutomatte/sleepless/releases/download/v0.1.1/Sleepless_0.1.1_aarch64.dmg)를 다운로드합니다.
...
src-tauri/target/release/bundle/dmg/Sleepless_0.1.1_aarch64.dmg
```
